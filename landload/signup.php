                        ...
                        <div class="card">
                            <form action="">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="nameId" type="text" name="username" placeholder="Your Username">
                                    <label for="nameId" id="nameIdErrMgs" class="col-form-label text-danger pull-right"></label>
                                </div>


                                <div class="form-group">
                                    <input class="form-control" id="emailId" type="E_mail" name="Email" placeholder="Your Email">
                                    <label for="emailId" id="emailIdErrMgs" class="col-form-label text-danger pull-right"></label>

                                </div>

                                <div class="form-group">
                                    <input class="form-control" id="mobileId" type="Number" name="usernumber" placeholder="Your mobile number">
                                    <label for="mobileId" id="mobileIdErrMgs" class="col-form-label text-danger pull-right"></label>

                                </div>

                                <div class="form-group">
                                    <input class="form-control" id="passwordId" type="Password" name="userpassword" placeholder="Password">
                                    <label for="passwordId" id="passwordIdErrMgs" class="col-form-label text-danger pull-right"> </label>
                                </div>

                                <div class="form-group">
                                    <input class="form-control" id="confPasswordId" type="Password" name="userpassword" placeholder="Confirm Password">
        ...
        $(document).ready(function() {
            ...
            $("#emailId").on("change", function() {
                ...
                if (email == false) {
                    ...
                    $("#emailIdErrMgs").text("Invalid Email Address! ..@gmail.com");
                    $("#emailIdErrMgs").show();
                    $("#emailId").focus();
                } else {
            ...
            function passwordCheck(){
                ...
                if (password == false) {
                    ...
                    $("#passwordIdErrMgs").text("Invalid password! Minimum one latter..");
